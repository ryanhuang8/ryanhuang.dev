  ...
  return (
    <div>
      ...
      <div className="flex-container">
        <ProjectBox project_name={'MemoTech 🏅'} extra_description='Hack@Brown 2024 Winner' project_description={'Helping students memorize flashcards with feedback from LLMs'} project_image={memoTech} tech={['Typescript', 'Flask', 'MongoDB']} links={{'Github' : 'https://github.com/ryanhuang8/memotech', 'Link' : 'https://bonono.netlify.app/', 'Devpost' : 'https://devpost.com/software/memotech-yfacpb'}} onClick={handleProjectBoxClick} changeProject={changeProject}></ProjectBox>
